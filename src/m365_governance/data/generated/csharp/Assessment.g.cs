...
// Schema sha256: a2a7cef7f5b61adcfbc0cb08ba547add034ad9ff0485b2d77dc986909c7bfed4
//
...
public sealed record Manifest(
    ...
    /// <summary>Which identity observed it, derived from the evidence. A delegated run sees what one person sees, and the difference changes what an empty result means. `imported` means the facts came from a tool this engine did not write and whose collection completeness it cannot verify. `mixed` means the documents do not agree, and it is never the reassuring answer: part of the archive is tenant-wide and part of it is one person's view, so the reader resolves it per document rather than taking an average.</summary>
