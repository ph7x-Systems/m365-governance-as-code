...
- 14 finding(s) reached no answer

## Summary

15 rules evaluated. **1 produced an answer.**
...
14 rules could not be decided. That is not compliance: missing evidence is a fact about collection, not about the resource.
