...
8 rules evaluated. **1 produced an answer.**
...
7 rules could not be decided. That is not compliance: missing evidence is a fact about collection, not about the resource.
